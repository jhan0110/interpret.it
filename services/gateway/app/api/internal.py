...
from app.models.tables import AttemptRow, MasteryScoreRow, ParaphraseEmbeddingRow, SegmentRow, SessionRow

router = APIRouter(prefix="/internal", tags=["internal"])


class _ParaphraseEmbedding(BaseModel):
    text: str
    embedding: list[float]


class _SegmentEmbeddingsRequest(BaseModel):
    paraphrases: list[_ParaphraseEmbedding]
